...
var helpers = {
  ...
  autoPlay: function () {
    ...
    var logTimer = () => {
      if(this.state.autoPlayTimer){
        this.state.totalMilLeft += checkInterval;
      }
      var progress = (this.state.totalMilLeft/this.props.autoplaySpeed)*100;
      this.setState({progress:progress});
      console.log(this.state, 'timer triggered')

      if(progress >= 100){
        play();
        this.setState({progress:0, totalMilLeft:0});
      }
